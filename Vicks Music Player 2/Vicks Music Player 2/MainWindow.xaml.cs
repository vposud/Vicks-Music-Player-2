...
namespace Vicks_Music_Player_2
{
    ...
    public partial class MainWindow : Window
    {
        ...
        #region Slider
        private void posSlider_PreviewMouseDown(object sender, System.Windows.Input.MouseButtonEventArgs e)
        {
            //stops the timer when clicking on the slider wheel
            CurrentTime.Stop();
        }
        ...
        private void RandomSong()
        {
            ...
            intRandomSong = rnd.Next(lstMain.Items.Count - 1);
        }
        ...
        private void btnPause_MouseEnter(object sender, System.Windows.Input.MouseEventArgs e)
        {
            if (MediaState == "Pause")
            {
                BitmapImage image = new BitmapImage(new Uri("/Icons/Media/pause_pressed.png", UriKind.Relative));
                imgPause.Source = image;
            }
            else
            {
        ...
        private void btnPause_PreviewMouseDown(object sender, System.Windows.Input.MouseButtonEventArgs e)
        {
            BitmapImage image = new BitmapImage(new Uri("/Icons/Media/pause_pressed.png", UriKind.Relative));
            imgPause.Source = image;
        }

        private void btnPause_PreviewMouseUp(object sender, System.Windows.Input.MouseButtonEventArgs e)
        {
            if (MediaState == "Play")
            {
                BitmapImage image = new BitmapImage(new Uri("/Icons/Media/pause_pressed.png", UriKind.Relative));
        ...
        private void LoadLibrary()
        {
            ...
            else
            {
                ...
                for (int i = 0; i < databaselist.Count - 1; i++)
                {
